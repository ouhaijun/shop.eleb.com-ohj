...
@section('contents')
    ...
    <form action="{{ route('menus.update',$menu) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>评分</label>
            <input type="number" name="rating" class="form-control" value="{{ $menu->rating }}">
        </div>
        <div class="form-group">
            <label>所属商家ID</label>
        ...
        <div class="form-group">
            <label>价格</label>
            <input type="number" name="goods_price" class="form-control" value="{{ $menu->goods_price }}">
        </div>
        <div class="form-group">
            <label>描述</label>
        ...
        <div class="form-group">
            <label>月销量</label>
            <input type="number" name="month_sales" class="form-control" value="{{ $menu->month_sales }}">
        </div>
        <div class="form-group">
            <label>评分数量</label>
            <input type="number" name="rating_count" class="form-control" value="{{ $menu->rating_count }}">
        </div>
        <div class="form-group">
            <label>提示信息</label>
        ...
        <div class="form-group">
            <label>满意度数量</label>
            <input type="number" name="satisfy_count" class="form-control" value="{{ $menu->satisfy_count }}">
        </div>
        <div class="form-group">
            <label>满意度评分</label>
            <input type="number" name="satisfy_rate" class="form-control" value="{{ $menu->satisfy_rate }}">
        </div>
            <div class="form-group">
                <label>商品图片</label>
        ...
        <div class="form-group">
            <label>状态</label>
            <input type="checkbox" name="status" value="1" @if($menu->status) checked="checked" @endif>
        </div>
        {{ csrf_field() }}
        {{ method_field('put') }}
